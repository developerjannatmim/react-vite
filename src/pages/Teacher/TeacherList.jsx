    ...
    <div className="container px-4">
      <div className="card">
        <div className="card-header">
          <h4>Teacher List</h4>
          <Link to="/teachers/create" className="btn btn-primary btn-sm float-end">
            Add Teacher
          </Link>
        </div>
          ...
          <table className="table table-striped">
            ...
            <tbody>
              {records?.map((teacherData) => {
                let userInformation;
                try {
                  userInformation = JSON.parse(teacherData?.user_information);
                } catch (error) {
                  /**/
                }
                return (
                  <tr key={teacherData?.id}>
                    ...
                    <td>
                      <Link
                        to={`/teachers/${teacherData.id}/show`}
                    ...
                    <td>
                      <Link
                        to={`/teachers/${teacherData.id}/edit`}
                    ...
                    <td
                      type="button"
                      onClick={(e) => deleteTeacherData(e, teacherData.id)}
