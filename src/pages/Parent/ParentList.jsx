    ...
    <div className="container px-4">
      <div className="card">
        <div className="card-header">
          <h4>Parent List</h4>
          <Link to="/parents/create" className="btn btn-primary btn-sm float-end">
            Add Parent
          </Link>
        </div>
          ...
          <table className="table table-striped">
            ...
            <tbody>
              {records?.map((parentData) => {
                let userInformation;
                try {
                  userInformation = JSON.parse(parentData?.user_information);
                } catch (error) {
                  /**/
                }
                return (
