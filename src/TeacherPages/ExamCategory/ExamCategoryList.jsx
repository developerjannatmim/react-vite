          ...
          <div className="mt-5 container px-4" style={{ marginLeft: '300px' }}>
            <div className="card">
              <div className="card-header">
                ...
                <Link
                  to="/teacher/exam-category/create"
                              ...
                              >
                                <li>
                                  <Link
                                    ...
                                    to={`/teacher/exam-category/${exam_category.id}/show`}
                                  >
                                    Show
                                  </Link>
                                </li>
                                <li>
                                  <Link
                                    className="dropdown-item"
                                    to={`/teacher/exam-category/${exam_category.id}/edit`}
                                  >
                                    Edit
                                  </Link>
                                </li>
                                <li>
                                  <Link
                                    className="dropdown-item"
                                    onClick={(e) =>
                                      deleteExamCategory(e, exam_category.id)
                                    }
                                  >
                                    Delete
                                  </Link>
